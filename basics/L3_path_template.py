...
forward_velocity = .166      # forward velocity (x dot) in m/s of SCUTTLE. NOTE that the max forward velocity of SCUTTLE is 0.4 m/s
...
motions = [
    [0.166, 0.0, 3.0],            # Motion 1
    [0.0, 1.0, 1.571],            # Motion 2
    [0.166, 0.0, 3.0],  
    [0.0, 1.0, 1.571],
    [0.166, 0.0, 3.0],
    [0.0, -1.0, 1.571],
